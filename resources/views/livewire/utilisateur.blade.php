                                ...
                                <tbody>
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button class="btn btn-warning mr-2" wire:click="selectItem({{$user->id}},'edit')">Edit</button>
                                                    <button class="btn btn-danger mr-2" wire:click="selectItem({{$user->id}},'delete')">Delete</button>
                                                </div>
                                            </td>
                                        </tr>
